...
locus = "12S" #name of target locus, see workflow notes above for your choices
output_folder <- "maine_verts_12S_2023-11-06" #name of your output folder every time
species_list <- read.csv("data/gom_inverts_2023-10-17/a03_BESTNAMES_v1.csv") # your species list
