---
title: "Quick reference library and gap analysis, Erin Grey 2023-08-04 *ADD FAMILY REP & TAXONOMY"
...
output_folder <- "gom_inverts_2022-11-27" #name of your output folder every time
family_list <- read.csv("data/Eukaryota_families_2023-07-12.csv") # list of eukaryote families, updated occasionally (see date in file name)
```
